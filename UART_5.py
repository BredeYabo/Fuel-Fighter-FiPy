...
#NB! WARNING Accelerometer NOT tested yet with UART
from machine import UART
from machine import SD
from utime import ticks_ms as ut
from time import sleep as ts
global sd,CAN_COUNT,OLD_CAN_ID,ID_FORMAT_INFO,brake,stw,bmss,brake,bms1,bms2,bms3,bmst,bmsvc,bmsef,mos,mts,s_try,sp,sp2,reason,temp,enco,dashb,frontls,rearls,py,acc,acc_count,acc_file,error_file,os_file
sd = SD()
...
if True:
    ...
    acc_file=None
    error_file=None
setting=5000#How many runs to do 1h~=50 000 but this varied wildly
def time_c(a):
    if int(a)>999:
