...
class Startiot:
  def __init__(self):
    self.dev_eui = binascii.unhexlify("ffffffff00001261")
    self.app_eui = binascii.unhexlify("00000000000001c8")
    self.app_key = binascii.unhexlify("7a322b614d795137744d705a7435676f")
